...
class BaseGame:
    ...
    def __init__(self, country_list, next_scene):
...
class Game(BaseGame):
    ...
    def __init__(self, game_map, country_list, quiz_type, next_scene):
        super().__init__(country_list, next_scene)
        self.width, self.height = game_map.get_size()
        self.game_map = game_map
        self.active_question = None
        self.active_pos = None
        # Use 1 for capital and 2 for country quiz. Used as index for lists.
